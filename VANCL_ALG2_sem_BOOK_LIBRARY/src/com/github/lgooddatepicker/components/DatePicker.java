...
public class DatePicker extends JPanel implements CustomPopupCloseListener {
    ...
    public void setDateTextFieldVisible(){
    ...
    private void initComponents() {
        ...
        dateTextField = new JTextField(){
            ...
            public void paintComponent (Graphics g) {
                if(load) {
                    try {
                        inputImage = ImageIO.read(getClass().getResourceAsStream("/com/Library/Images/inputBackground.png")).getScaledInstance(140,50,Image.SCALE_DEFAULT);
        ...
        Image img = null;
        try {
            img = ImageIO.read(getClass().getResourceAsStream("/com/Library/Images/buttonDate.png"));
        } catch (Exception ignore){ }
        ImageIcon icon = new ImageIcon(img.getScaledInstance(130,40,Image.SCALE_DEFAULT));

        toggleCalendarButton = new JButton("",icon);
        toggleCalendarButton.setBorderPainted(false);
        toggleCalendarButton.setOpaque(false);
        toggleCalendarButton.setContentAreaFilled(false);
        ...
        toggleCalendarButton.setBounds(toggleCalendarButton.getX(),toggleCalendarButton.getY(),140,50);
